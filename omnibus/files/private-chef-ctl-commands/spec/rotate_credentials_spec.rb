  ...
  context "require_credential_rotation_pre_hook" do
    ...
    context "when rotation is required" do
      ...
      it "allows 'chef-server-ctl rotate-shared-secrets' to be run" do
        expect do
          subject.run_global_pre_hooks(%w{opscode /opt/opscode/embedded/service/omnibus-ctl rotate-shared-secrets})
      ...
      it "raises an error and exits with non rotation commands" do
        ...
        expect do
          subject.run_global_pre_hooks(%w{opscode /opt/opscode/embedded/service/omnibus-ctl reconfigure})
