...
migration_action(OrgRecord, _AcctInfo) ->
    ...
    OrgAdminsAuthzId = 
        case get_server_admins_authz_group_if_exists(OrgId) of
...
get_server_admins_authz_group_if_exists(OrgId) ->
    case sqerl:select(get_server_admins_authz_group_if_exists_sql(OrgId),
...
get_server_admins_authz_group_if_exists_sql(OrgId) ->
